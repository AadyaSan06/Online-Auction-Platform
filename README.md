...
## DEMO 
Login page
<img width="661" height="624" alt="image" src="https://github.com/user-attachments/assets/d78e01dd-33ae-40a4-92b0-2ba14b6a89f8" />

Server side gui
<img width="730" height="704" alt="image" src="https://github.com/user-attachments/assets/058aca02-986f-4665-8aed-deb292e83aab" />

User side gui
<img width="899" height="1073" alt="image" src="https://github.com/user-attachments/assets/23e67fa8-90e5-40a8-9399-e04ed766e5b1" />

Timer
<img width="897" height="1089" alt="image" src="https://github.com/user-attachments/assets/cd183d0d-19df-468a-9b8d-0013d2ab71cc" />

Pop Up Alerts
<img width="864" height="1008" alt="image" src="https://github.com/user-attachments/assets/9d75292a-aa9b-4a10-81f9-50edabc9492f" />

Winner 

https://github.com/user-attachments/assets/ca1a2b14-713b-47bb-81ed-168d8d57e7a5
...
python server.py
```
Launch Bidders: Open multiple terminals and run:
```bash
python client.py
```
